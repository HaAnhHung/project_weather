...
abstract class _$$WeatherLoadingImplCopyWith<$Res> {
  factory _$$WeatherLoadingImplCopyWith(
    _$WeatherLoadingImpl value,
...
class __$$WeatherLoadingImplCopyWithImpl<$Res>
  ...
  __$$WeatherLoadingImplCopyWithImpl(
    _$WeatherLoadingImpl _value,
    $Res Function(_$WeatherLoadingImpl) _then,
  ) : super(_value, _then);
...
class __$$WeatherLoadedImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? isForecastLoading = freezed,
    Object? forecastError = freezed,
  }) {
    return _then(
      _$WeatherLoadedImpl(
        weather:
        ...
        isForecastLoading:
            freezed == isForecastLoading
                ? _value.isForecastLoading
                : isForecastLoading // ignore: cast_nullable_to_non_nullable
                    as bool?,
        forecastError:
            freezed == forecastError
                ? _value.forecastError
                : forecastError // ignore: cast_nullable_to_non_nullable
                    as String?,
      ),
    );
  }
...
class _$WeatherLoadedImpl implements WeatherLoaded {
  const _$WeatherLoadedImpl({
    ...
    this.isForecastLoading,
    this.forecastError,
  }) : _forecast = forecast;

  @override
  final WeatherEntity weather;
  final List<WeatherEntity>? _forecast;
  @override
  List<WeatherEntity>? get forecast {
  ...
  @override
  String toString() {
    return 'WeatherState.loaded(weather: $weather, forecast: $forecast, isForecastLoading: $isForecastLoading, forecastError: $forecastError)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isForecastLoading, isForecastLoading) ||
                other.isForecastLoading == isForecastLoading) &&
            (identical(other.forecastError, forecastError) ||
                other.forecastError == forecastError));
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(weather, forecast, isForecastLoading, forecastError);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(weather, forecast, isForecastLoading, forecastError);
  }
...
abstract class WeatherLoaded implements WeatherState {
  ...
  List<WeatherEntity>? get forecast;
  bool? get isForecastLoading;
  String? get forecastError;
...
abstract class _$$WeatherErrorImplCopyWith<$Res> {
  factory _$$WeatherErrorImplCopyWith(
    _$WeatherErrorImpl value,
    $Res Function(_$WeatherErrorImpl) then,
...
class __$$WeatherErrorImplCopyWithImpl<$Res>
  ...
  __$$WeatherErrorImplCopyWithImpl(
    _$WeatherErrorImpl _value,
    $Res Function(_$WeatherErrorImpl) _then,
  ) : super(_value, _then);
