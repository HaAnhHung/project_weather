...
class _$SettingsStateImpl implements _SettingsState {
  const _$SettingsStateImpl({this.isCelsius = true});
  ...
  @override
  String toString() {
    return 'SettingsState(isCelsius: $isCelsius)';
  }
...
abstract class _SettingsState implements SettingsState {
  const factory _SettingsState({final bool isCelsius}) = _$SettingsStateImpl;
